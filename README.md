<div align="center">
  <h1>" Sparkle Note - 우리들의 빛나는 추억 💫 "</h1>

  <br>

  [![스파클노트 이용해보기](https://github.com/user-attachments/assets/2835ca67-b6c2-4d3c-8674-5bc311d4e83b)](https://sparklenote.site/)

  <br>

  <p>⬆️ 우리들만의 롤링페이퍼 만들기</p>
  <br>
  <br>

  <p>롤링페이퍼는 단순한 종이가 아닙니다.<br>
    그건 마음과 마음이 이어지는 <strong style="font-size : 16px">다리</strong>이고,<br>
    어느 날 문득 꺼내볼 수 있는 작고 <strong style="font-size : 16px">소중한 추억</strong>입니다 💫
  </p>
